...
gameOfLife3d::gameOfLife3d(int gridsz, std::vector<glm::vec3> initialBoxes, int lL, int lU, int rL, int rU) : gridManager(gridsz) {
...
int gameOfLife3d::getState(int xin, int yin, int zin) const {
...
void gameOfLife3d::editBox(int xin, int yin, int zin, int editType, bool playerEdit) const {
...
void gameOfLife3d::render(unsigned int &VAO, Shader &shaderProgram) {
